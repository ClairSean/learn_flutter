...
final User user_0 = User(
  ...
  avatarUrl: 'lib/04_adaptive_responsive/02_general/assets/avatar_1.png',
  lastActive: DateTime.now(),
);
final User user_1 = User(
  name: const Name(first: '老', last: '强'),
  avatarUrl: 'lib/04_adaptive_responsive/02_general/assets/avatar_2.png',
  lastActive: DateTime.now().subtract(const Duration(minutes: 10)),
);
final User user_2 = User(
  name: const Name(first: 'So', last: 'Duri'),
  avatarUrl: 'lib/04_adaptive_responsive/02_general/assets/avatar_3.png',
...
final User user_3 = User(
  ...
  avatarUrl: 'lib/04_adaptive_responsive/02_general/assets/avatar_4.png',
  lastActive: DateTime.now().subtract(const Duration(hours: 2)),
);
final User user_4 = User(
  name: const Name(first: 'Ziad', last: 'Aouad'),
  avatarUrl: 'lib/04_adaptive_responsive/02_general/assets/avatar_5.png',
...
final List<Email> emails = [
  ...
  Email(
    ...
    attachments: [
      const Attachment(
        url: 'lib/04_adaptive_responsive/02_general/assets/thumbnail_1.png',
      ),
    ],
  ),
  Email(
